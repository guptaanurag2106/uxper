...
- **Deque**: Implementing the Deque concatenative programming language in Go - [Wiki](https://www.concatenative.org/wiki/view/Deque), [Rule 110](https://en.wikipedia.org/wiki/Rule_110)
- **BF**: Simple Brainfuck interpreter written in C - [Wikipedia](https://en.wikipedia.org/wiki/Brainfuck)
...
- **RLE**: Custom file compression utility using Run-Length Encoding bit-packing - [Wikipedia](https://en.wikipedia.org/wiki/Run-length_encoding)
